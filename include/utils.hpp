...
print_usage(const char* program)
{
    ...
    fprintf(stdout, "  -m <mode to process bales: \"combine\" or \"cascade\" >   : the 1st mode is simply combining dictionaries, the 2nd considers historical dictionary content.\n");
};
