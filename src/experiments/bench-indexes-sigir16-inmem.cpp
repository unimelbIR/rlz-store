    ...
    block_factor_data& bfd)
{
    ...
    coder_zzz.encode_block_output(os,bfd,block_id,"RLZP2A-ZZZ");
}
    ...
    block_factor_data& bfd)
{
    ...
    coder_zzz.encode_block_output(os,bfd,block_id,"RLZP2B-ZZZ");
}
    ...
    block_factor_data& bfd)
{
    ...
    coder_zzz.encode_block_output(os,bfd,block_id,"RLZP2C-ZZZ");
}
...
int main(int argc, const char* argv[])
{
    ...
    // using www_type_packed = rlz_store_static<dict_local_coverage_norms<dict_segment_size_bytes>,
    //                                               dict_pruning_strategy,
    //                                               dict_index_type,
    //                                               factorization_blocksize,
    //                                               default_search_local_context,
...

    {
        ...
        // auto rlz_store = www_type_packed::builder{}
        //                      .set_rebuild(args.rebuild)
        //                      .set_threads(args.threads)
        //                      .set_dict_size(dict_size_bytes)
        //                      .build_or_load(col);
        ...
        while(fitr != fend) {
            ...
            if (fitr.last_factor_in_block()) {
                ...
                compress_rlzp2a_block_inmem(p1pv_coder,p1zzz_coder,fitr.block_id,fs,factor_data,segment_table,segment_size_log2,dict_idx,bfd);
